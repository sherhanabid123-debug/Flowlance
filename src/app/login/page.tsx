      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isLogin && (
              <div className="flex justify-end mt-1">
                <motion.button 
                  ...
                  className="text-[10px] font-bold opacity-50 hover:opacity-100 hover:text-primary transition-all uppercase tracking-widest px-1"
                >
                  Forgot Password?
                </motion.button>
              </div>
          ...
          <motion.button 
            ...
            disabled={loading}
            type="submit" 
            className="w-full py-3 rounded-xl bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-all flex justify-center items-center shadow-lg shadow-primary/20"
          >
            {loading ? <span className="animate-spin mr-2 text-lg">⏳</span> : null}
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white text-black font-bold transition-all border border-gray-200 shadow-sm group active:shadow-inner"
        >
