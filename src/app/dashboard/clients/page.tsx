    ...
    <div className="pt-12 text-left relative">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <button onClick={handleAddNew} className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary text-white px-5 py-2.5 rounded-xl font-bold hover:opacity-90 transition-opacity whitespace-nowrap text-sm sm:text-base shadow-lg shadow-primary/20 btn-lift">
      ...
      <div className="glass rounded-2xl p-3 md:p-6 mb-8 flex flex-col md:flex-row gap-4 justify-between items-center z-10 sticky top-20">
        ...
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl input-clean outline-none text-sm"
          />
        </div>
      </div>
