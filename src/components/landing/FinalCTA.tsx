    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <motion.div 
           ...
           viewport={{ once: true }}
           className="glass p-12 sm:p-20 rounded-[48px] bg-gradient-to-br from-primary/20 to-indigo-600/20 border-primary/20 text-center space-y-10 relative overflow-hidden"
        >
           ...
           <div className="space-y-4 max-w-2xl mx-auto">
              <h2 className="text-4xl sm:text-5xl font-bold tracking-tight">Start managing your clients <span className="text-primary italic">today</span>.</h2>
              <p className="text-lg opacity-70">Focus on your craft, not the follow-ups. Join 200+ freelancers growing their business with Flowlance.</p>
           </div>
           ...
           <div className="flex flex-wrap items-center justify-center gap-8 pt-4">
              {benefits.map((b, i) => (
                 <div key={i} className="flex items-center gap-2 opacity-60">
                    ...
                    <span className="text-sm font-semibold uppercase tracking-wider">{b}</span>
                 </div>
              ))}
           </div>
        </motion.div>
