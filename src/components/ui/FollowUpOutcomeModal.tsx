...
export function FollowUpOutcomeModal({ isOpen, onClose, onSubmit, clientName, history = [] }: FollowUpOutcomeModalProps) {
    ...
    >
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        {history && history.length > 0 && (
          <div className="lg:w-80 border-t lg:border-t-0 lg:border-l border-[var(--border)] pt-8 lg:pt-0 lg:pl-8">
