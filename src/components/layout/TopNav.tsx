...
export function TopNav() {
  ...
  return (
    <motion.header 
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="h-20 flex items-center justify-between px-4 lg:px-8 glass border-b sticky top-0 z-40 lg:ml-[280px] nm-card"
    >
      ...
      <div className="flex items-center space-x-1 sm:space-x-2">
        ...
        {isAuthenticated ? (
          ...
          <button 
            ...
            className="bg-primary text-primary-foreground px-3 sm:px-5 py-2 rounded-xl font-bold text-xs sm:text-sm hover:opacity-90 transition-all active:scale-95 shadow-lg shadow-primary/20 nm-btn"
          >
            Sign In
          </button>
        )}
